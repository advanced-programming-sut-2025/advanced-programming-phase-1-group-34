...
public enum CropCreator {
    ...
    CORN("Corn", "Corn Seeds", new int[]{2, 3, 3, 3, 3}, 14, false, 4, 50, true, 25, 11, new String[]{"Summer", "Fall"}, false),
    ...
    SUNFLOWER("Sunflower", "Sunflower Seeds", new int[]{1, 2, 3, 2}, 8, true, 0, 80, true, 45, 20, new String[]{"Summer", "Fall"}, false),
    TOMATO("Tomato", "Tomato Seeds", new int[]{2, 2, 2, 2, 3}, 11, false, 4, 60, true, 20, 9, new String[]{"Summer"}, false),
    WHEAT("Wheat", "Wheat Seeds", new int[]{1, 1, 1, 1}, 4, true, 0, 25, false, 0, 0, new String[]{"Summer", "Fall"}, false),
    AMARANTH("Amaranth", "Amaranth Seeds", new int[]{1, 2, 2, 2}, 7, true, 0, 150, true, 50, 22, new String[]{"Fall"}, false),
    ARTICHOKE("Artichoke", "Artichoke Seeds", new int[]{2, 2, 1, 2, 1}, 8, true, 0, 160, true, 30, 13, new String[]{"Fall"}, false),
    BEET("Beet", "Beet Seeds", new int[]{1, 1, 2, 2}, 6, true, 0, 100, true, 30, 13, new String[]{"Fall"}, false),
    BOK_CHOY("Bok Choy", "Bok Choy Seeds", new int[]{1, 1, 1, 1}, 4, true, 0, 80, true, 25, 11, new String[]{"Fall"}, false),
    BROCCOLI("Broccoli", "Broccoli Seeds", new int[]{2, 2, 2, 2}, 8, false, 4, 70, true, 63, 28, new String[]{"Fall"}, false),
    CRANBERRIES("Cranberries", "Cranberry Seeds", new int[]{1, 2, 1, 1, 2}, 7, false, 5, 75, true, 38, 17, new String[]{"Fall"}, false),
    EGGPLANT("Eggplant", "Eggplant Seeds", new int[]{1, 1, 1, 1}, 5, false, 5, 60, true, 20, 9, new String[]{"Fall"}, false),
    FAIRY_ROSE("Fairy Rose", "Fairy Seeds", new int[]{1, 4, 4, 3}, 12, true, 0, 290, true, 45, 20, new String[]{"Fall"}, false),
    GRAPE("Grape", "Grape Starter", new int[]{1, 1, 2, 3, 3}, 10, false, 3, 80, true, 38, 17, new String[]{"Fall"}, false),
    PUMPKIN("Pumpkin", "Pumpkin Seeds", new int[]{1, 2, 3, 4, 3}, 13, true, 0, 320, false, 0, 0, new String[]{"Fall"}, true),
    YAM("Yam", "Yam Seeds", new int[]{1, 3, 3, 3}, 10, true, 0, 160, true, 45, 20, new String[]{"Fall"}, false),
    SWEET_GEM_BERRY("Sweet Gem Berry", "Rare Seed", new int[]{2, 4, 6, 6, 6}, 24, true, 0, 3000, false, 0, 0, new String[]{"Fall"}, false),
    POWDERMELON("Powdermelon", "Powdermelon Seeds", new int[]{1, 2, 1, 2, 1}, 7, true, 0, 60, true, 63, 28, new String[]{"Winter"}, true),
    ANCIENT_FRUIT("Ancient Fruit", "Ancient Seeds", new int[]{2, 7, 7, 7, 5}, 28, false, 7, 550, false, 0, 0, new String[]{"Spring", "Summer", "Fall"}, false);
