...
public enum ForagingMineralCreator {
    ...
    ForagingMineralCreator(String name, String description, int sellPrice) {
        this.name = name;
        this.description = description;
        this.sellPrice = sellPrice;
    }

    public ForagingMineral createInstance() {
        return new ForagingMineral(name, description, sellPrice);
    }
}
