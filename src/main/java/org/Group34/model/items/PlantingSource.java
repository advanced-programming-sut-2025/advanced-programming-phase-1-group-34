...
public enum PlantingSource implements Item {
    ...
    POMEGRANATE_SAPLING("Pomegranate Sapling", TreeCreator.POMEGRANATE_TREE::createInstance, Season.ALL, 6000, 0, "Takes 28 days to produce a mature Pomegranate tree. Bears fruit in the fall. Only grows if the 8 surrounding \"tiles\" are empty."),
