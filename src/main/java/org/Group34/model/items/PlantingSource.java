...
public enum PlantingSource implements Item {
    ...
    // Crops – Autumn
    AMARANTH_SEEDS("Amaranth Seeds", CropCreator.AMARANTH::createInstance, Season.AUTUMN),
    ARTICHOKE_SEEDS("Artichoke Seeds", CropCreator.ARTICHOKE::createInstance, Season.AUTUMN),
    BEET_SEEDS("Beet Seeds", CropCreator.BEET::createInstance, Season.AUTUMN),
    BOK_CHOY_SEEDS("Bok Choy Seeds", CropCreator.BOK_CHOY::createInstance, Season.AUTUMN),
    BROCCOLI_SEEDS("Broccoli Seeds", CropCreator.BROCCOLI::createInstance, Season.AUTUMN),
    CRANBERRY_SEEDS("Cranberry Seeds", CropCreator.CRANBERRIES::createInstance, Season.AUTUMN),
    EGGPLANT_SEEDS("Eggplant Seeds", CropCreator.EGGPLANT::createInstance, Season.AUTUMN),
    FAIRY_SEEDS("Fairy Seeds", CropCreator.FAIRY_ROSE::createInstance, Season.AUTUMN),
    GRAPE_STARTER("Grape Starter", CropCreator.GRAPE::createInstance, Season.AUTUMN),
    PUMPKIN_SEEDS("Pumpkin Seeds", CropCreator.PUMPKIN::createInstance, Season.AUTUMN),
    YAM_SEEDS("Yam Seeds", CropCreator.YAM::createInstance, Season.AUTUMN),
    RARE_SEED("Rare Seed", CropCreator.SWEET_GEM_BERRY::createInstance, Season.AUTUMN),
